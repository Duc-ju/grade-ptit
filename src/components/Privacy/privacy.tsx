...
function Privacy() {
  useEffect(() => {
    document.title = "Grade Tool Privacy";
  }, []);
  ...
  return (
    <section style={{ padding: "16px" }}>
      ...
      <p>
        Ju Team built the Grade Tool app as a Free app. This SERVICE is provided
        by Ju Team at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Grade Tool unless
      ...
      <p>This policy is effective as of 2024-03-18</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at trangduc56@gmail.com.
      </p>{" "}
    </section>
  );
}
